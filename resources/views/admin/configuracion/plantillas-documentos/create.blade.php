<x-app-layout>
    <x-slot name="title">Nueva Plantilla de Documento</x-slot>
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            ...
            <div class="flex justify-between items-start">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Nueva Plantilla de Documento</h1>
                    <p class="text-gray-600 text-sm mt-1">Crea una nueva plantilla para generar documentos PDF</p>
                </div>
        ...
        <form id="formPlantilla">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            placeholder="Descripción breve de la plantilla y su propósito"></textarea>
                    </div>

                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="activo" id="activo" checked class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div id="tab-contenido" class="tab-content active">
                    ...
                    <textarea id="contenido_html" name="contenido_html" class="w-full" style="height: 400px;"></textarea>
                </div>
                ...
                <div id="tab-encabezado" class="tab-content" style="display: none;">
                    ...
                    <textarea id="encabezado_html" name="encabezado_html" class="w-full" style="height: 400px;"></textarea>
                </div>
                ...
                <div id="tab-pie" class="tab-content" style="display: none;">
                    ...
                    <textarea id="pie_pagina_html" name="pie_pagina_html" class="w-full" style="height: 400px;"></textarea>
                </div>
                ...
                <div id="tab-estilos" class="tab-content" style="display: none;">
                    ...
                    <textarea id="contenido_css" name="contenido_css" class="w-full" style="height: 400px;"></textarea>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="margen_superior" id="margen_superior" value="25" min="0" max="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Margen Inferior (mm)</label>
                        <input type="number" name="margen_inferior" id="margen_inferior" value="25" min="0" max="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Margen Izquierdo (mm)</label>
                        <input type="number" name="margen_izquierdo" id="margen_izquierdo" value="25" min="0" max="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Margen Derecho (mm)</label>
                        <input type="number" name="margen_derecho" id="margen_derecho" value="25" min="0" max="100"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div id="variables-obligatorias-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <p class="text-sm text-gray-500 italic col-span-full">Las variables detectadas aparecerán aquí automáticamente</p>
                </div>
            </div>
        </form>
    </div>
