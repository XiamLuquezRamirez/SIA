                    ...
                    <div class="tab-content">
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div id="funcionarioFields" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">
                                        Asignar Líder <span class="text-red-500">*</span>
                                    </label>
                                    <select name="lider_id" id="lider_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
